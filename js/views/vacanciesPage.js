    ...
    tr.innerHTML = `
        ...
        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
            <div class="flex items-center space-x-2">
                <button data-edit-id="${vacancy.vacancy_id}" class="edit-vacancy-btn text-blue-600 hover:text-blue-900 p-2 hover:bg-blue-50 rounded-lg transition-all" title="Edit">
                ...
                <button data-view-id="${vacancy.vacancy_id}" class="view-vacancy-btn text-gray-600 hover:text-gray-900 p-2 hover:bg-gray-50 rounded-lg transition-all" title="Show">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256">
                ...
                <button data-delete-id="${vacancy.vacancy_id}" class="delete-vacancy-btn text-red-600 hover:text-red-900 p-2 hover:bg-red-50 rounded-lg transition-all" title="Delete">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256">
...
async function handleFormSubmit(event) {
    ...
    try {
        ...
        submitBtn.innerHTML = 'Save Vacancy';
    }
}
